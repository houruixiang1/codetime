...
"use strict";
    ...
    G.prototype.D = function(e) {
        for (var t = new Buffer.from(e,"base64").toString("binary"), n = t.charCodeAt(0) << 8 | t.charCodeAt(1), r = [], i = 2; i < n + 2; i += 2)
    ...
    function get_sign(){
       var e = "client_id=c3cef7c66a1843f8b3a9e6a1e3160e20&grant_type=password&timestamp=1637228784061&source=com.zhihu.web&signature=e28ef9da0c8d36bb502b4a1935586731354e14ad&username=%2B8618737540525&password=123456&captcha=&lang=cn&utm_source=&ref_source=other_https%3A%2F%2Fwww.zhihu.com%2Fsignin%3Fnext%3D%252F";
       // var e = '143910a4ea0769499a149e3ace014423';
        return b(e)
       // console.log(b(e))
    }