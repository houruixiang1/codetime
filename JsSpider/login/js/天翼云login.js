...
i = [],
a = [];
for (i[15] = a[15] = void 0, o.length > 16 && (o = p(o, 8 * t.length)), n = 0; n < 16; n += 1) i[n] = 909522486 ^ o[n],
a[n] = 1549556828 ^ o[n];
...
function signature() {
var n = (new Date).getTime() - 1123
var t = "s54zv9bm1vd5czfujy6nnuxj1l4g2ny6";
var r = S(n+seqcode()+S(seqcode() + t + n));
return r
}
function seqcode() {
...
c = [];
if (a = a || r.length, t) for (e = 0; e < t; e++) c[e] = r[0 | Math.random() * a];
else for (c[8] = c[13] = c[18] = c[23] = "-", c[14] = "4", e = 0; e < 36; e++) c[e] || (n = 0 | 16 * Math.random(), c[e] = r[19 === e ? 3 & n | 8 : n]);
return c.join("")
}