...
if (!this.finalized) {
    ...
    l = this.blocks,
    c = this.buffer8; o < r;) {
        if (this.hashed && (this.hashed = !1, l[0] = l[16], l[16] = l[1] = l[2] = l[3] = l[4] = l[5] = l[6] = l[7] = l[8] = l[9] = l[10] = l[11] = l[12] = l[13] = l[14] = l[15] = 0), t) if (ARRAY_BUFFER) for (i = this.start; o < r && i < 64; ++o) c[i++] = e[o];
        else for (i = this.start; o < r && i < 64; ++o) l[i >> 2] |= e[o] << SHIFT[3 & i++];
        else if (ARRAY_BUFFER) for (i = this.start; o < r && i < 64; ++o)(code = e.charCodeAt(o)) < 128 ? c[i++] = code: code < 2048 ? (c[i++] = 192 | code >> 6, c[i++] = 128 | 63 & code) : code < 55296 || code >= 57344 ? (c[i++] = 224 | code >> 12, c[i++] = 128 | code >> 6 & 63, c[i++] = 128 | 63 & code) : (code = 65536 + ((1023 & code) << 10 | 1023 & e.charCodeAt(++o)), c[i++] = 240 | code >> 18, c[i++] = 128 | code >> 12 & 63, c[i++] = 128 | code >> 6 & 63, c[i++] = 128 | 63 & code);
        else for (i = this.start; o < r && i < 64; ++o)(code = e.charCodeAt(o)) < 128 ? l[i >> 2] |= code << SHIFT[3 & i++] : code < 2048 ? (l[i >> 2] |= (192 | code >> 6) << SHIFT[3 & i++], l[i >> 2] |= (128 | 63 & code) << SHIFT[3 & i++]) : code < 55296 || code >= 57344 ? (l[i >> 2] |= (224 | code >> 12) << SHIFT[3 & i++], l[i >> 2] |= (128 | code >> 6 & 63) << SHIFT[3 & i++], l[i >> 2] |= (128 | 63 & code) << SHIFT[3 & i++]) : (code = 65536 + ((1023 & code) << 10 | 1023 & e.charCodeAt(++o)), l[i >> 2] |= (240 | code >> 18) << SHIFT[3 & i++], l[i >> 2] |= (128 | code >> 12 & 63) << SHIFT[3 & i++], l[i >> 2] |= (128 | code >> 6 & 63) << SHIFT[3 & i++], l[i >> 2] |= (128 | 63 & code) << SHIFT[3 & i++]);
...
if (!this.finalized) {
    ...
    e[i >> 2] |= EXTRA[3 & i],
    i >= 56 && (this.hashed || this.hash(), e[0] = e[16], e[16] = e[1] = e[2] = e[3] = e[4] = e[5] = e[6] = e[7] = e[8] = e[9] = e[10] = e[11] = e[12] = e[13] = e[14] = e[15] = 0),
    e[14] = this.bytes << 3,
...
this.first ? b = ((b = ((a = ((a = r[0] - 680876937) << 7 | a >>> 25) - 271733879 << 0) ^ (e = ((e = ( - 271733879 ^ (t = ((t = ( - 1732584194 ^ 2004318071 & a) + r[1] - 117830708) << 12 | t >>> 20) + a << 0) & ( - 271733879 ^ a)) + r[2] - 1126478375) << 17 | e >>> 15) + t << 0) & (t ^ a)) + r[3] - 1316259209) << 22 | b >>> 10) + e << 0 : (a = this.h0, b = this.h1, e = this.h2, b = ((b += ((a = ((a += ((t = this.h3) ^ b & (e ^ t)) + r[0] - 680876936) << 7 | a >>> 25) + b << 0) ^ (e = ((e += (b ^ (t = ((t += (e ^ a & (b ^ e)) + r[1] - 389564586) << 12 | t >>> 20) + a << 0) & (a ^ b)) + r[2] + 606105819) << 17 | e >>> 15) + t << 0) & (t ^ a)) + r[3] - 1044525330) << 22 | b >>> 10) + e << 0),
...
this.first ? (this.h0 = a + 1732584193 << 0, this.h1 = b - 271733879 << 0, this.h2 = e - 1732584194 << 0, this.h3 = t + 271733878 << 0, this.first = !1) : (this.h0 = this.h0 + a << 0, this.h1 = this.h1 + b << 0, this.h2 = this.h2 + e << 0, this.h3 = this.h3 + t << 0)
},
...
function get_sign(data) {
    return o = _(_(data += "28c8edde3d61a0411511d3b1866f0636"))
}